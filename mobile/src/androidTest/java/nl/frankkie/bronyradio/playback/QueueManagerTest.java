 ...
 */
package nl.frankkie.bronyradio.playback;
...
import nl.frankkie.bronyradio.TestSetupHelper;
import nl.frankkie.bronyradio.model.MusicProvider;
import nl.frankkie.bronyradio.utils.MediaIDHelper;
import nl.frankkie.bronyradio.utils.QueueHelper;
import nl.frankkie.bronyradio.utils.SimpleMusicProviderSource;
...
public class QueueManagerTest {
    ...
    public void testIsSameBrowsingCategory() throws Exception {
        ...
        Iterator<String> genres = provider.getGenresOld().iterator();
    ...
    public void testSetQueueFromMusic() throws Exception {
        ...
        // mediaId
        String genre = provider.getGenresOld().iterator().next();
